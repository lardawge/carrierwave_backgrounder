...
I like CarrierWave. That being said, I don't like slowing down my users as well as tying up a instances waiting for images to process and upload to S3. Depending on the size of the file, this could take a while. This gem takes care of that. After the file has been uploaded and CarrierWave caches the initial file, it halts the process and queues a Delayed Job.
...
In your CarrierWave uploader file:
    ...
    require 'carrierwave/backgrounder'
...
In your model:
    ...
    store_in_background :avatar #New
